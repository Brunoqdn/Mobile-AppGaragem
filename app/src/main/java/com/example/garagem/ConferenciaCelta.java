...
public class ConferenciaCelta extends AppCompatActivity {

    private TextView mensagem_celta;

    private EditText atual;
    private Button verificar_celta;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conferencia_celta);
        ...
        mensagem_celta = (TextView) findViewById(R.id.mensagem_celta);
        verificar_celta = (Button) findViewById(R.id.verificar_fiesta);


        verificar_celta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (km >= oleo + 10000) {
                    mensagem_celta.setText("Trocar Óleo!");
                    mensagem_celta.setBackgroundColor(Color.RED);
                    mensagem_celta.setTextColor(Color.BLACK);

                }else if (km >= oleo + 8000) {
                    mensagem_celta.setText("Trocar Óleo em Breve !");
                    mensagem_celta.setBackgroundColor(Color.YELLOW);
                    mensagem_celta.setTextColor(Color.BLACK);

                } else {
                    mensagem_celta.setText("Óleo OK!");
                    mensagem_celta.setBackgroundColor(Color.GREEN);
                    mensagem_celta.setTextColor(Color.BLACK);
                }
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(getApplicationContext(), "Erro, Print a tela Manualmente e envie ao responsável pela Vtr", Toast.LENGTH_LONG).show();
                }
