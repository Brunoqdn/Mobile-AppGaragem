...
public class ConferenciaFiesta extends AppCompatActivity {

    private TextView mensagem_fiesta;

    private EditText atual;
    private Button verificar_fiesta;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conferencia_fiesta);
        ...
        mensagem_fiesta = (TextView) findViewById(R.id.mensagem_fiesta);
        verificar_fiesta = (Button) findViewById(R.id.verificar_fiesta);


        verificar_fiesta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (km >= oleo + 10000) {
                    mensagem_fiesta.setText("Trocar Óleo!");
                    mensagem_fiesta.setBackgroundColor(Color.RED);
                    mensagem_fiesta.setTextColor(Color.BLACK);

                }else if (km >= oleo + 8000) {
                    mensagem_fiesta.setText("Trocar Óleo em Breve !");
                    mensagem_fiesta.setBackgroundColor(Color.YELLOW);
                    mensagem_fiesta.setTextColor(Color.BLACK);

                } else {
                    mensagem_fiesta.setText("Óleo OK!");
                    mensagem_fiesta.setBackgroundColor(Color.GREEN);
                    mensagem_fiesta.setTextColor(Color.BLACK);
                }
            }
