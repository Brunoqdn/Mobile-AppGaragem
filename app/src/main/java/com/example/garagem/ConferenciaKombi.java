...
public class ConferenciaKombi extends AppCompatActivity {

    private TextView mensagemKombi;

    private EditText atual;
    private Button verificarKombi;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conferencia_kombi);
        ...
        mensagemKombi = (TextView) findViewById(R.id.mensagemKombi);
        verificarKombi = (Button) findViewById(R.id.verificarKombi);


        verificarKombi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (km >= oleo + 10000) {
                    mensagemKombi.setText("Trocar Óleo!");
                    mensagemKombi.setBackgroundColor(Color.RED);
                    mensagemKombi.setTextColor(Color.BLACK);

                }else if (km >= oleo + 8000) {
                    mensagemKombi.setText("Trocar Óleo em Breve !");
                    mensagemKombi.setBackgroundColor(Color.YELLOW);
                    mensagemKombi.setTextColor(Color.BLACK);

                } else {
                    mensagemKombi.setText("Óleo OK!");
                    mensagemKombi.setBackgroundColor(Color.GREEN);
                    mensagemKombi.setTextColor(Color.BLACK);
                }
            }
