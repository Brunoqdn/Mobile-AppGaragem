...
public class ConferenciaPolo extends AppCompatActivity {

    private TextView mensagem_polo;

    private EditText atual;
    private Button verificar_polo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conferencia_polo);
        ...
        mensagem_polo = (TextView) findViewById(R.id.mensagem_polo);
        verificar_polo = (Button) findViewById(R.id.verificar_polo);


        verificar_polo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (km >= oleo + 10000) {
                    mensagem_polo.setText("Trocar Óleo!");
                    mensagem_polo.setBackgroundColor(Color.RED);
                    mensagem_polo.setTextColor(Color.BLACK);

                }else if (km >= oleo + 8000) {
                    mensagem_polo.setText("Trocar Óleo em Breve !");
                    mensagem_polo.setBackgroundColor(Color.YELLOW);
                    mensagem_polo.setTextColor(Color.BLACK);

                } else {
                    mensagem_polo.setText("Óleo OK!");
                    mensagem_polo.setBackgroundColor(Color.GREEN);
                    mensagem_polo.setTextColor(Color.BLACK);
                }
            }
